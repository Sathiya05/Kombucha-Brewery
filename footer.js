...
document.addEventListener("DOMContentLoaded", () => {
  ...
  footer.innerHTML = `
<footer class=" w-full transition-colors duration-500 bg-gray-50 dark:bg-black border-t-4 relative overflow-hidden" style="border-top-color: var(--kombu-green);">
  ...
  <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 grid gap-12 grid-cols-1 md:grid-cols-12">
    ...
    <div class="md:col-span-12 lg:col-span-4 pr-0 lg:pr-8">
      ...
      <div class="flex gap-3">
        <a href="#" class="w-10 h-10 flex items-center justify-center rounded-full transition-all duration-300 text-gray-500 dark:text-gray-400 bg-white dark:bg-[#111111] border border-gray-200 dark:border-gray-800 hover:text-white dark:hover:text-white hover:border-transparent hover:scale-110 shadow-sm" onmouseover="this.style.backgroundColor='var(--kombu-orange)'" onmouseout="this.style.backgroundColor=''">
    ...
    <div class="md:col-span-6 lg:col-span-2">
      ...
      <ul class="space-y-4 text-sm font-bold">
        <li>
          <a href="index.html" class="footer-link flex items-center text-gray-600 dark:text-gray-400 transition-all duration-300">
            <i class="fas fa-chevron-right text-[10px] mr-2 opacity-0 -ml-4 transition-all duration-300" style="color: var(--kombu-orange);"></i>
            <span>Home</span>
          </a>
        </li>
        <li>
          <a href="about.html" class="footer-link flex items-center text-gray-600 dark:text-gray-400 transition-all duration-300">
            <i class="fas fa-chevron-right text-[10px] mr-2 opacity-0 -ml-4 transition-all duration-300" style="color: var(--kombu-orange);"></i>
            <span>About</span>
          </a>
        </li>
        <li>
          <a href="process.html" class="footer-link flex items-center text-gray-600 dark:text-gray-400 transition-all duration-300">
            <i class="fas fa-chevron-right text-[10px] mr-2 opacity-0 -ml-4 transition-all duration-300" style="color: var(--kombu-orange);"></i>
            <span>Process</span>
          </a>
        </li>
        <li>
          <a href="taproom.html" class="footer-link flex items-center text-gray-600 dark:text-gray-400 transition-all duration-300">
            <i class="fas fa-chevron-right text-[10px] mr-2 opacity-0 -ml-4 transition-all duration-300" style="color: var(--kombu-orange);"></i>
    ...
    <div class="md:col-span-6 lg:col-span-2">
      ...
      <ul class="space-y-4 text-sm font-bold">
        <li>
          <a href="faq.html" class="footer-link flex items-center text-gray-600 dark:text-gray-400 transition-all duration-300">
        ...
        <li>
          <a href="shipping.html" class="footer-link flex items-center text-gray-600 dark:text-gray-400 transition-all duration-300">
            <i class="fas fa-chevron-right text-[10px] mr-2 opacity-0 -ml-4 transition-all duration-300" style="color: var(--kombu-green);"></i>
            <span>Shipping Info</span>
          </a>
        </li>
        <li>
          <a href="wholesale.html" class="footer-link flex items-center text-gray-600 dark:text-gray-400 transition-all duration-300">
            <i class="fas fa-chevron-right text-[10px] mr-2 opacity-0 -ml-4 transition-all duration-300" style="color: var(--kombu-green);"></i>
            <span>Wholesale</span>
          </a>
        </li>
        <li>
          <a href="contact.html" class="footer-link flex items-center text-gray-600 dark:text-gray-400 transition-all duration-300">
            <i class="fas fa-chevron-right text-[10px] mr-2 opacity-0 -ml-4 transition-all duration-300" style="color: var(--kombu-green);"></i>
            <span>Contact</span>
          </a>
        </li>
    ...
    <div class="md:col-span-12 lg:col-span-4">
      ...
      <form class="flex flex-col sm:flex-row gap-2" id="newsletterForm">
        <input type="email" placeholder="Your email address..." class="flex-1 px-5 py-3.5 bg-white dark:bg-[#111111] text-gray-900 dark:text-white font-semibold rounded-full border-2 border-gray-200 dark:border-gray-800 focus:outline-none focus:border-[#8FC140] dark:focus:border-[#8FC140] transition-colors shadow-sm w-full">
  ...
  <div class="border-t border-gray-200 dark:border-gray-800 relative z-10">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col md:flex-row gap-4 justify-between items-center text-xs font-bold text-gray-500 dark:text-gray-500">
